import{S as _,i as g,s as w,D as r,x as b,y as v,z as x,A as R,B as u,r as $,p as M,C as T,V as k,e as m,t as E,k as C,c as d,a as y,h as H,d as l,m as z,b as A,g as i,F as D,n as P}from"../../chunks/index-f095e7d9.js";import{P as S}from"../../chunks/post-34b2f3fb.js";function B(c){let s,t,o,e,n=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">CreateMyDynamicModel</span> <span class="token operator">&lt;</span> ActiveRecord<span class="token double-colon punctuation">::</span>Migration
...
<span class="token keyword">end</span> <span class="token comment">#/end class</span></code>`;return{c(){s=m("p"),t=E(`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),o=C(),e=m("pre"),this.h()},l(a){s=d(a,"P",{});var p=y(s);t=H(p,`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),p.forEach(l),o=z(a),e=d(a,"PRE",{class:!0});var h=y(e);h.forEach(l),this.h()},h(){A(e,"class","language-ruby")},m(a,p){i(a,s,p),D(s,t),i(a,o,p),i(a,e,p),e.innerHTML=n},p:P,d(a){a&&l(s),a&&l(o),a&&l(e)}}}function Z(c){let s,t;const o=[c[0],f];let e={$$slots:{default:[B]},$$scope:{ctx:c}};for(let n=0;n<o.length;n+=1)e=r(e,o[n]);return s=new S({props:e}),{c(){b(s.$$.fragment)},l(n){v(s.$$.fragment,n)},m(n,a){x(s,n,a),t=!0},p(n,[a]){const p=a&1?R(o,[a&1&&u(n[0]),a&0&&u(f)]):{};a&2&&(p.$$scope={dirty:a,ctx:n}),s.$set(p)},i(n){t||($(s.$$.fragment,n),t=!0)},o(n){M(s.$$.fragment,n),t=!1},d(n){T(s,n)}}}const f={draft:!0,comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Dynamic Models in Rails 3",description:"How to create dynamic Models in Rails 3",excerpt:"Rails 3 has a lot of nifty new features.",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2016-09-06T09:45:57.000Z",updated_at:"2016-09-06T09:45:57.000Z",meta:[{property:"og:image",content:"/images/GSoC-logo-horizontal-800.png"},{name:"twitter:image",content:"/images/GSoC-logo-horizontal-800.png"}],lastmod:"2022-06-13T01:54:22.847Z"};function j(c,s,t){return c.$$set=o=>{t(0,s=r(r({},s),k(o)))},s=k(s),[s]}class L extends _{constructor(s){super(),g(this,s,j,Z,w,{})}}export{L as default,f as metadata};
