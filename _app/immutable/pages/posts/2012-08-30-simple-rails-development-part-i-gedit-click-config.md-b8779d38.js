import{S as io,i as lo,s as no,D as xt,x as ao,y as so,z as ro,A as uo,B as eo,r as co,p as ho,C as fo,X as to,e as i,t as a,k as h,c as l,a as n,h as s,d as t,m as f,b as T,g as u,F as o,n as po}from"../../chunks/index-1458cd2c.js";import{P as mo}from"../../chunks/post-a3452a60.js";function go($){let c,g,y,v,d,m,R,M,Ge,ue,w,P,Q,Ae,Oe,Se,D,U,qe,Le,Ne,z,B,$e,Me,ce,F,Pe,he,G,De,fe,b,ze,A,Fe,He,de,O,We,pe,k,Ye,S,je,Ze,me,_,J,V,Qe,Ue,X,K,Be,Je,ee,te,Ve,ge,E,Xe,oe,Ke,et,ye,I,tt,ie,ot,it,ve,C,lt,le,nt,at,we,q,st,_e,H,rt,be,L,ut,ke,p,N,ct,ne,ht,ft,dt,W,pt,ae,mt,gt,se,yt,vt,Y,wt,re,_t;return{c(){c=i("p"),g=a(`After evaluating all editors and IDEs I could ahold of for Ruby On Rails
...
Ruby words are pretty simple: they:`),Ie.forEach(t),me=f(e),_=l(e,"OL",{});var Z=n(_);J=l(Z,"LI",{});var Pt=n(J);V=l(Pt,"STRONG",{});var Dt=n(V);Qe=s(Dt,"can begin with a single $ sign"),Dt.forEach(t),Pt.forEach(t),Ue=f(Z),X=l(Z,"LI",{});var zt=n(X);K=l(zt,"STRONG",{});var Ft=n(K);Be=s(Ft,"can begin with a single or double @ sign, a"),Ft.forEach(t),zt.forEach(t),Je=f(Z),ee=l(Z,"LI",{});var Ht=n(ee);te=l(Ht,"STRONG",{});var Wt=n(te);Ve=s(Wt,"can contain any letter a-z, case insensitive"),Wt.forEach(t),Ht.forEach(t),Z.forEach(t),ge=f(e),E=l(e,"P",{});var Ce=n(E);Xe=s(Ce,`I like to add a fourth rule, just for constants, because when i select a part of
a constant, i want the whole thing: `),oe=l(Ce,"STRONG",{});var Yt=n(oe);Ke=s(Yt,"can contain two colons in a row"),Yt.forEach(t),et=s(Ce,"."),Ce.forEach(t),ye=f(e),I=l(e,"P",{});var xe=n(I);tt=s(xe,`To put all that in simple regular
