import{S as Ct,i as Mt,s as Pt,D as Xe,x as xt,y as Dt,z as Lt,A as Ht,B as _t,r as Wt,p as Ot,C as Rt,L as It,e as l,t as n,k as u,c as r,a as s,h as o,d as t,m,b as C,g as h,I as a,n as Bt}from"../../chunks/index-ee30ad4e.js";import{P as Nt}from"../../chunks/post-d418ea34.js";import"../../chunks/settings-69239d06.js";function $t(L){let d,y,v,S,c,p,w,fe,X,_,ye,A,ve,Se,F,we,_e,ee,b,Ie,H,ge,be,te,E,Ee,j,Te,ke,ae,M,bt='<code class="language-html"><span class="token comment">&lt;!--#echo var="REQUEST_URI"--></span></code>',ne,W,Ce,oe,O,Me,ie,R,Pe,le,P,Et='<code class="language-html"><span class="token comment">&lt;!--#directive parameter=value--></span></code>',re,T,xe,K,De,Le,se,x,He,he,B,We,de,I,N,Y,Oe,Re,Be,k,Z,Ne,$e,q,Ue,Ge,Ae,f,z,Fe,je,Q,Ke,Ye,J,Ze,qe,D,ze,Qe,ce,$,Je;return{c(){d=l("h2"),y=n("Introduction"),v=u(),S=l("p"),c=n(`Back in the day, in 2000, I started creating my own Content Management System ,
...
called SaMS. I created it in Perl , as this was the only server technology
available to me at that time. When I created my DynDNS account and got my own
domain and a stable place to live, I started...`};function Gt(L,d,y){return L.$$set=v=>{y(0,d=Xe(Xe({},d),It(v)))},d=It(d),[d]}class Kt extends Ct{constructor(d){super(),Mt(this,d,Gt,Ut,Pt,{})}}export{Kt as default,gt as metadata};
