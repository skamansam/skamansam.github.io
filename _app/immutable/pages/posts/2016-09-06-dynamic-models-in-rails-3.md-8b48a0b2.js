import{S as _,i as w,s as g,D as r,x as v,y as b,z as R,A as x,B as u,r as M,p as $,C as T,L as d,e as m,t as H,k as C,c as k,a as y,h as E,d as l,m as A,b as D,g as i,I as P,n as B}from"../../chunks/index-ee30ad4e.js";import{P as I}from"../../chunks/post-d418ea34.js";import"../../chunks/settings-69239d06.js";function L(c){let s,t,o,e,n=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">CreateMyDynamicModel</span> <span class="token operator">&lt;</span> ActiveRecord<span class="token double-colon punctuation">::</span>Migration
...
`};function z(c,s,t){return c.$$set=o=>{t(0,s=r(r({},s),d(o)))},s=d(s),[s]}class q extends _{constructor(s){super(),w(this,s,z,j,g,{})}}export{q as default,f as metadata};
