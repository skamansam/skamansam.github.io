import{S as pe,i as _e,s as ve,D as ee,x as Ee,y as ye,z as ge,A as we,B as de,r as be,p as Ne,C as Te,X as ue,e as s,t as u,k as p,c as r,a as d,h as m,d as t,m as _,b as L,g as o,F as l,n as Oe}from"../../chunks/index-1458cd2c.js";import{P as Se}from"../../chunks/post-a3452a60.js";function xe(N){let a,h,I,f,i,c,v,X,k,T,V,A,E,H,x,K,q,R,O,W,B,S,$,C,y,D,j,z,G,w,ce=`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
...
virtual machine because it rebuilds everyting on the fly.`),c=p(),v=s("p"),X=u("I went to the Gentoo site and downloaded the minimal install CD for ia64. No luck here - it won\u2019t even boot, just hangs."),k=p(),T=s("p"),V=u(`Then I downloaded the minimal install CD for amd64. I got into the boot loader and booted the system, but it hung on the
