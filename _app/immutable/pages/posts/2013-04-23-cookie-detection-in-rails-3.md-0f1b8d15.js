import{S as C,i as D,s as B,D as R,x as L,y as q,z as F,A as H,B as $,r as J,p as N,C as S,L as A,e as f,t as y,k as v,c as _,a as h,h as w,d as o,m as g,b as U,g as r,I as x,n as V}from"../../chunks/index-a5078a7d.js";import{P as Y}from"../../chunks/post-ac48aa50.js";function Z(u){let e,p,l,t,a=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">ApplicationController</span> <span class="token operator">&lt;</span> ActionController<span class="token double-colon punctuation">::</span>Base
...
enabled, they should not be using your app. Plan for the future and leave behind
older browsers. You are not expected to support everyone!`),I.forEach(o),this.h()},h(){U(t,"class","language-ruby")},m(s,i){r(s,e,i),x(e,p),r(s,l,i),r(s,t,i),t.innerHTML=a,r(s,n,i),r(s,c,i),x(c,m),r(s,k,i),r(s,d,i),x(d,b)},p:V,d(s){s&&o(e),s&&o(l),s&&o(t),s&&o(n),s&&o(c),s&&o(k),s&&o(d)}}}function j(u){let e,p;const l=[u[0],E];let t={$$slots:{default:[Z]},$$scope:{ctx:u}};for(let a=0;a<l.length;a+=1)t=R(t,l[a]);return e=new Y({props:t}),{c(){L(e.$$.fragment)},l(a){q(e.$$.fragment,a)},m(a,n){F(e,a,n),p=!0},p(a,[n]){const c=n&1?H(l,[n&1&&$(a[0]),n&0&&$(E)]):{};n&2&&(c.$$scope={dirty:n,ctx:a}),e.$set(c)},i(a){p||(J(e.$$.fragment,a),p=!0)},o(a){N(e.$$.fragment,a),p=!1},d(a){S(e,a)}}}const E={comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Cookie Detection in Rails 3",description:"How to detect cookies in Rails 3",excerpt:"I believe this may be a bad idea, in general, but here is a cheap way",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2013-04-23T17:14:12.000Z",updated_at:"2016-08-30T00:00:00.000Z"};function z(u,e,p){return u.$$set=l=>{p(0,e=R(R({},e),A(l)))},e=A(e),[e]}class K extends C{constructor(e){super(),D(this,e,z,j,B,{})}}export{K as default,E as metadata};
