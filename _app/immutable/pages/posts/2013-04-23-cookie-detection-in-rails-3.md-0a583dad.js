import{S as C,i as J,s as D,D as x,x as B,y as H,z as L,A as N,B as A,r as V,p as q,C as F,L as $,e as k,t as y,k as w,c as f,a as b,h as v,d as o,m as g,b as S,g as c,I,n as U}from"../../chunks/index-ee30ad4e.js";import{P as Y}from"../../chunks/post-d418ea34.js";import"../../chunks/settings-69239d06.js";function Z(u){let e,i,r,n,s=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">ApplicationController</span> <span class="token operator">&lt;</span> ActionController<span class="token double-colon punctuation">::</span>Base
...
..And Voila! Now if your...`};function z(u,e,i){return u.$$set=r=>{i(0,e=x(x({},e),$(r)))},e=$(e),[e]}class O extends C{constructor(e){super(),J(this,e,z,j,D,{})}}export{O as default,E as metadata};
