import{S as io,i as no,s as lo,D as xt,x as ao,y as so,z as ro,A as uo,B as eo,r as co,p as ho,C as fo,U as to,e as i,t as a,k as h,c as n,a as l,h as s,d as t,m as f,b as G,g as u,F as o,n as po}from"../../chunks/index-e257a78e.js";import{P as mo}from"../../chunks/post-11de8cff.js";function go($){let c,g,y,v,d,m,T,M,Re,ue,w,P,U,Ae,Se,Oe,D,Q,qe,Le,Ne,z,B,$e,Me,ce,F,Pe,he,R,De,fe,b,ze,A,Fe,He,de,S,We,pe,k,Ye,O,je,Ze,me,_,J,V,Ue,Qe,K,X,Be,Je,ee,te,Ve,ge,E,Ke,oe,Xe,et,ye,I,tt,ie,ot,it,ve,C,nt,ne,lt,at,we,q,st,_e,H,rt,be,L,ut,ke,p,N,ct,le,ht,ft,dt,W,pt,ae,mt,gt,se,yt,vt,Y,wt,re,_t;return{c(){c=i("p"),g=a(`After evaluating all editors and IDEs I could ahold of for Ruby On Rails
...
took me by surprise: Click Config.`),y=h(),v=i("p"),d=i("strong"),m=a("NOTE: This article is written for GEdit 3+. A simple Google search will yield many articles for Gedit 2."),T=h(),M=i("p"),Re=a("Most IDEs and editors have different functions when multi-clicking in an editor pane. Most of them have the following selection actions:"),ue=h(),w=i("ul"),P=i("li"),U=i("strong"),Ae=a("Single-Click"),Se=a(": Move the editing cursor to the mouse cursor\u2019s location"),Oe=h(),D=i("li"),Q=i("strong"),qe=a("Double-Click"),Le=a(": Select the word that is under the mouse cursor"),Ne=h(),z=i("li"),B=i("strong"),$e=a("Triple-Click"),Me=a(": Select the entire line that is under the mouse cursor"),ce=h(),F=i("p"),Pe=a(`Only a few editors have a quad-click option for selecting an entire paragraph.
...
Ruby words are pretty simple: they:`),me=h(),_=i("ol"),J=i("li"),V=i("strong"),Ue=a("can begin with a single $ sign"),Qe=h(),K=i("li"),X=i("strong"),Be=a("can begin with a single or double @ sign, a"),Je=h(),ee=i("li"),te=i("strong"),Ve=a("can contain any letter a-z, case insensitive"),ge=h(),E=i("p"),Ke=a(`I like to add a fourth rule, just for constants, because when i select a part of
...
an undiscovered basic text editor in Fedora: GEdit.\xA0In order to make my rails
development a little easier, I installed a few plugins, but only one of them
took me by surprise: Click Config.`),r.forEach(t),y=f(e),v=n(e,"P",{});var Gt=l(v);d=n(Gt,"STRONG",{});var Tt=l(d);m=s(Tt,"NOTE: This article is written for GEdit 3+. A simple Google search will yield many articles for Gedit 2."),Tt.forEach(t),Gt.forEach(t),T=f(e),M=n(e,"P",{});var Rt=l(M);Re=s(Rt,"Most IDEs and editors have different functions when multi-clicking in an editor pane. Most of them have the following selection actions:"),Rt.forEach(t),ue=f(e),w=n(e,"UL",{});var j=l(w);P=n(j,"LI",{});var bt=l(P);U=n(bt,"STRONG",{});var At=l(U);Ae=s(At,"Single-Click"),At.forEach(t),Se=s(bt,": Move the editing cursor to the mouse cursor\u2019s location"),bt.forEach(t),Oe=f(j),D=n(j,"LI",{});var kt=l(D);Q=n(kt,"STRONG",{});var St=l(Q);qe=s(St,"Double-Click"),St.forEach(t),Le=s(kt,": Select the word that is under the mouse cursor"),kt.forEach(t),Ne=f(j),z=n(j,"LI",{});var Et=l(z);B=n(Et,"STRONG",{});var Ot=l(B);$e=s(Ot,"Triple-Click"),Ot.forEach(t),Me=s(Et,": Select the entire line that is under the mouse cursor"),Et.forEach(t),j.forEach(t),ce=f(e),F=n(e,"P",{});var qt=l(F);Pe=s(qt,`Only a few editors have a quad-click option for selecting an entire paragraph.
GEdit Click Config not only has a quad-click option, but has a quit-click (five
clicks in quick succession) option as well. Amazing! Not only can you configure
what click-types are available in GEdit, but you can configure the click
parameters based on a given regular expression (\u201Cregex\u201D for short). And to top
...
Ruby words are pretty simple: they:`),Ie.forEach(t),me=f(e),_=n(e,"OL",{});var Z=l(_);J=n(Z,"LI",{});var Pt=l(J);V=n(Pt,"STRONG",{});var Dt=l(V);Ue=s(Dt,"can begin with a single $ sign"),Dt.forEach(t),Pt.forEach(t),Qe=f(Z),K=n(Z,"LI",{});var zt=l(K);X=n(zt,"STRONG",{});var Ft=l(X);Be=s(Ft,"can begin with a single or double @ sign, a"),Ft.forEach(t),zt.forEach(t),Je=f(Z),ee=n(Z,"LI",{});var Ht=l(ee);te=n(Ht,"STRONG",{});var Wt=l(te);Ve=s(Wt,"can contain any letter a-z, case insensitive"),Wt.forEach(t),Ht.forEach(t),Z.forEach(t),ge=f(e),E=n(e,"P",{});var Ce=l(E);Ke=s(Ce,`I like to add a fourth rule, just for constants, because when i select a part of
a constant, i want the whole thing: `),oe=n(Ce,"STRONG",{});var Yt=l(oe);Xe=s(Yt,"can contain two colons in a row"),Yt.forEach(t),et=s(Ce,"."),Ce.forEach(t),ye=f(e),I=n(e,"P",{});var xe=l(I);tt=s(xe,`To put all that in simple regular
