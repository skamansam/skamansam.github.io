import{S as Ct,i as xt,s as Pt,D as Ve,x as Mt,y as Lt,z as Dt,A as Ht,B as wt,r as Ot,p as Rt,C as Wt,X as gt,e as n,t as o,k as c,c as r,a as s,h as l,d as t,m as p,b as C,g as h,F as a,n as Gt}from"../../chunks/index-1458cd2c.js";import{P as $t}from"../../chunks/post-3074b800.js";function Ut(D){let d,v,y,_,u,f,S,me,V,w,ve,A,ye,_e,F,Se,we,ee,b,ge,H,Ie,be,te,E,Ee,j,Te,ke,ae,x,bt='<code class="language-html"><span class="token comment">&lt;!--#echo var="REQUEST_URI"--></span></code>',oe,O,Ce,le,R,xe,ie,W,Pe,ne,P,Et='<code class="language-html"><span class="token comment">&lt;!--#directive parameter=value--></span></code>',re,T,Me,z,Le,De,se,M,He,he,G,Oe,de,g,$,Z,Re,We,Ge,k,K,$e,Ue,Y,Be,Ne,Ae,m,q,Fe,je,Q,ze,Ze,X,Ke,Ye,L,qe,Qe,ue,U,Xe;return{c(){d=n("h2"),v=o("Introduction"),y=c(),_=n("p"),u=o(`Back in the day, in 2000, I started creating my own Content Management System ,
...
Server-Side includes to create a web site that is easy to maintain.`),f=c(),S=n("h2"),me=o("Getting Started"),V=c(),w=n("p"),ve=o(`The only thing you will need is a web server with SSI enabled. If you have SSI
...
SSI directives into the top of the page, like so: `),Q=n("code"),ze=o('<!--#include virtual="/include/header.html"-->'),Ze=o(" \u2026[content goes here]\u2026"),X=n("code"),Ke=o('<!--#include virtual="/include/footer.html"-->'),Ye=o(`. The include directive includes the page
...
file.)`),ue=c(),U=n("p"),Xe=o("There we are! A very simple SSI-enabled site. Keep reading for more of what you can do with this."),this.h()},l(e){d=r(e,"H2",{id:!0});var i=s(d);v=l(i,"Introduction"),i.forEach(t),y=p(e),_=r(e,"P",{});var et=s(_);u=l(et,`Back in the day, in 2000, I started creating my own Content Management System ,
called SaMS. I created it in Perl , as this was the only server technology
available to me at that time. When I created my DynDNS account and got my own
domain and a stable place to live, I started redesigning my website. SaMS could
have been used, but I had found easier ways to do the same stuff, mainly
Server-Side Includes. In this article, I will explain very briefly how to use
Server-Side includes to create a web site that is easy to maintain.`),et.forEach(t),f=p(e),S=r(e,"H2",{id:!0});var tt=s(S);me=l(tt,"Getting Started"),tt.forEach(t),V=p(e),w=r(e,"P",{});var B=s(w);ve=l(B,`The only thing you will need is a web server with SSI enabled. If you have SSI
...
SSI directives into the top of the page, like so: `),Q=r(I,"CODE",{});var vt=s(Q);ze=l(vt,'<!--#include virtual="/include/header.html"-->'),vt.forEach(t),Ze=l(I," \u2026[content goes here]\u2026"),X=r(I,"CODE",{});var yt=s(X);Ke=l(yt,'<!--#include virtual="/include/footer.html"-->'),yt.forEach(t),Ye=l(I,`. The include directive includes the page
named. The virtual parameter means to use the URI to include the file, instead
of the absolute path on the server.( If you go to
