import{S as pe,i as ge,s as ye,D as ee,x as ve,y as _e,z as be,A as Ee,B as de,r as we,p as Ne,C as Se,L as ue,e as l,t as u,k as p,c as r,a as d,h as m,d as t,m as g,b as M,g as o,I as s,n as Oe}from"../../chunks/index-ee30ad4e.js";import{P as Te}from"../../chunks/post-d418ea34.js";import"../../chunks/settings-69239d06.js";function ke(N){let a,c,I,f,i,h,y,V,L,S,X,A,v,H,k,K,q,R,O,W,B,T,$,C,_,x,j,z,G,E,he=`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
...
I am currently taking a class on Operating System design and need to do some kernel hacking for the class. I thought about 
modifying the Fedora kernel, but decided against it, as I still want a stable system to operate in. So I looked into 
virtual machines, as Fedora has...`};function De(N,a,c){return N.$$set=I=>{c(0,a=ee(ee({},a),ue(I)))},a=ue(a),[a]}class Re extends pe{constructor(a){super(),ge(this,a,De,xe,ye,{})}}export{Re as default,me as metadata};
