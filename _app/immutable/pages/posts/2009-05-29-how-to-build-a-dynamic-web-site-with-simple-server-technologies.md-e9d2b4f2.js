import{S as Ct,i as xt,s as Pt,D as Xe,x as Mt,y as Lt,z as Dt,A as Ht,B as wt,r as Ot,p as Rt,C as Wt,U as gt,e as n,t as o,k as c,c as r,a as s,h as l,d as t,m as p,b as C,g as h,F as a,n as Gt}from"../../chunks/index-e257a78e.js";import{P as Ut}from"../../chunks/post-11de8cff.js";function $t(D){let d,v,y,_,u,f,S,me,X,w,ve,A,ye,_e,F,Se,we,ee,b,ge,H,Ie,be,te,E,Ee,j,Te,ke,ae,x,bt='<code class="language-html"><span class="token comment">&lt;!--#echo var="REQUEST_URI"--></span></code>',oe,O,Ce,le,R,xe,ie,W,Pe,ne,P,Et='<code class="language-html"><span class="token comment">&lt;!--#directive parameter=value--></span></code>',re,T,Me,z,Le,De,se,M,He,he,G,Oe,de,g,U,Z,Re,We,Ge,k,K,Ue,$e,Y,Be,Ne,Ae,m,q,Fe,je,Q,ze,Ze,J,Ke,Ye,L,qe,Qe,ue,$,Je;return{c(){d=n("h2"),v=o("Introduction"),y=c(),_=n("p"),u=o(`Back in the day, in 2000, I started creating my own Content Management System ,
...
some have two.`),se=c(),M=n("h2"),He=o("The Setup"),he=c(),G=n("p"),Oe=o("In order to create a page that is easily maintainable, you need to do three things:"),de=c(),g=n("ul"),U=n("li"),Z=n("strong"),Re=o("Create a template"),We=o(`. Create a page that will represent the
...
this tutorial.`),Ge=c(),k=n("li"),K=n("strong"),Ue=o("\u201CChunk\u201D the page"),$e=o(`. Break up the page into the sections, and
...
SSI directives into the top of the page, like so: `),Q=n("code"),ze=o('<!--#include virtual="/include/header.html"-->'),Ze=o(" \u2026[content goes here]\u2026"),J=n("code"),Ke=o('<!--#include virtual="/include/footer.html"-->'),Ye=o(`. The include directive includes the page
...
file.)`),ue=c(),$=n("p"),Je=o("There we are! A very simple SSI-enabled site. Keep reading for more of what you can do with this."),this.h()},l(e){d=r(e,"H2",{id:!0});var i=s(d);v=l(i,"Introduction"),i.forEach(t),y=p(e),_=r(e,"P",{});var et=s(_);u=l(et,`Back in the day, in 2000, I started creating my own Content Management System ,
called SaMS. I created it in Perl , as this was the only server technology
available to me at that time. When I created my DynDNS account and got my own
domain and a stable place to live, I started redesigning my website. SaMS could
have been used, but I had found easier ways to do the same stuff, mainly
...
some have two.`),fe.forEach(t),se=p(e),M=r(e,"H2",{id:!0});var dt=s(M);He=l(dt,"The Setup"),dt.forEach(t),he=p(e),G=r(e,"P",{});var ut=s(G);Oe=l(ut,"In order to create a page that is easily maintainable, you need to do three things:"),ut.forEach(t),de=p(e),g=r(e,"UL",{});var N=s(g);U=r(N,"LI",{});var Ve=s(U);Z=r(Ve,"STRONG",{});var ct=s(Z);Re=l(ct,"Create a template"),ct.forEach(t),We=l(Ve,`. Create a page that will represent the
layout of all thpages on your site. I recommend creating several areas: a
header, a footer, a navigation section, and a toolbar or news section. I will
be using the areas I defined\xA0 for my web site (those listed previously) in
this tutorial.`),Ve.forEach(t),Ge=p(N),k=r(N,"LI",{});var V=s(k);K=r(V,"STRONG",{});var pt=s(K);Ue=l(pt,"\u201CChunk\u201D the page"),pt.forEach(t),$e=l(V,`. Break up the page into the sections, and
put the related html into separate files. For instance, I put all the html
from `),Y=r(V,"CODE",{});var ft=s(Y);Be=l(ft,"<?xml..?>"),ft.forEach(t),Ne=l(V,` to the tag that represents the content area into a file
called \u201Cinclude/header.html\u201D. We will use SSI to reasseble the page
later.`),V.forEach(t),Ae=p(N),m=r(N,"LI",{});var I=s(m);q=r(I,"STRONG",{});var mt=s(q);Fe=l(mt,"Create the SSI"),mt.forEach(t),je=l(I,`. In each of your main content pages, place the
SSI directives into the top of the page, like so: `),Q=r(I,"CODE",{});var vt=s(Q);ze=l(vt,'<!--#include virtual="/include/header.html"-->'),vt.forEach(t),Ze=l(I," \u2026[content goes here]\u2026"),J=r(I,"CODE",{});var yt=s(J);Ke=l(yt,'<!--#include virtual="/include/footer.html"-->'),yt.forEach(t),Ye=l(I,`. The include directive includes the page
named. The virtual parameter means to use the URI to include the file, instead
of the absolute path on the server.( If you go to
