import{S as C,i as q,s as B,C as R,y as D,z as H,A as L,H as F,$ as I,g as J,d as N,B as S,L as A,k as f,q as y,a as v,l as _,m as h,r as w,h as o,c as g,n as U,b as r,G as x,I as V}from"./index.37f37dfa.js";import{P as Y}from"./post.47922bc8.js";function Z(u){let e,l,p,t,a=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">ApplicationController</span> <span class="token operator">&lt;</span> ActionController<span class="token double-colon punctuation">::</span>Base
...
enabled, they should not be using your app. Plan for the future and leave behind
older browsers. You are not expected to support everyone!`),$.forEach(o),this.h()},h(){U(t,"class","language-ruby")},m(s,i){r(s,e,i),x(e,l),r(s,p,i),r(s,t,i),t.innerHTML=a,r(s,n,i),r(s,c,i),x(c,m),r(s,k,i),r(s,d,i),x(d,b)},p:V,d(s){s&&o(e),s&&o(p),s&&o(t),s&&o(n),s&&o(c),s&&o(k),s&&o(d)}}}function j(u){let e,l;const p=[u[0],E];let t={$$slots:{default:[Z]},$$scope:{ctx:u}};for(let a=0;a<p.length;a+=1)t=R(t,p[a]);return e=new Y({props:t}),{c(){D(e.$$.fragment)},l(a){H(e.$$.fragment,a)},m(a,n){L(e,a,n),l=!0},p(a,[n]){const c=n&1?F(p,[n&1&&I(a[0]),n&0&&I(E)]):{};n&2&&(c.$$scope={dirty:n,ctx:a}),e.$set(c)},i(a){l||(J(e.$$.fragment,a),l=!0)},o(a){N(e.$$.fragment,a),l=!1},d(a){S(e,a)}}}const E={comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Cookie Detection in Rails 3",description:"How to detect cookies in Rails 3",excerpt:"I believe this may be a bad idea, in general, but here is a cheap way",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2013-04-23T17:14:12.000Z",updated_at:"2016-08-30T00:00:00.000Z"};function z(u,e,l){return u.$$set=p=>{l(0,e=R(R({},e),A(p)))},e=A(e),[e]}class K extends C{constructor(e){super(),q(this,e,z,j,B,{})}}export{K as default,E as metadata};
