...
`},{draft:v,comments:g,view:$,layout:W,lang:A,author:x,title:C,description:S,excerpt:H,cover:P,coverImage:B,coverAlt:R,categories:T,tags:Z,created_at:k,updated_at:z,preview:E,previewHtml:F,textContent:L}=e;var c=i(`<p>Since I am a web developer, I prefer to test my web sites on as many browsers as
possible. With this said, I installed the W3C's Amaya browser/editor today, and
was pleasantly surprised to see that no errors occured. I simply downloaded the
source tarball, and used a few commands:</p> <code></code>`,1);function j(t,s){const a=l(s,["children","$$slots","$$events","$$legacy"]);m(t,p(()=>a,()=>e,{children:(o,w)=>{var r=c();n(2),d(o,r)},$$slots:{default:!0}}))}export{j as default,e as metadata};
