import{S as _,i as w,s as g,C as r,y as b,z as v,A as R,H as x,$ as u,g as $,d as M,B as E,L as k,k as d,q as H,a as T,l as m,m as y,r as A,h as l,c as P,n as B,b as i,G as C,I as D}from"./index.37f37dfa.js";import{P as I}from"./post.47922bc8.js";function L(c){let s,t,o,e,n=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">CreateMyDynamicModel</span> <span class="token operator">&lt;</span> ActiveRecord<span class="token double-colon punctuation">::</span>Migration
...
any version of Rails.`),o=T(),e=d("pre"),this.h()},l(a){s=m(a,"P",{});var p=y(s);t=A(p,`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),p.forEach(l),o=P(a),e=m(a,"PRE",{class:!0});var h=y(e);h.forEach(l),this.h()},h(){B(e,"class","language-ruby")},m(a,p){i(a,s,p),C(s,t),i(a,o,p),i(a,e,p),e.innerHTML=n},p:D,d(a){a&&l(s),a&&l(o),a&&l(e)}}}function j(c){let s,t;const o=[c[0],f];let e={$$slots:{default:[L]},$$scope:{ctx:c}};for(let n=0;n<o.length;n+=1)e=r(e,o[n]);return s=new I({props:e}),{c(){b(s.$$.fragment)},l(n){v(s.$$.fragment,n)},m(n,a){R(s,n,a),t=!0},p(n,[a]){const p=a&1?x(o,[a&1&&u(n[0]),a&0&&u(f)]):{};a&2&&(p.$$scope={dirty:a,ctx:n}),s.$set(p)},i(n){t||($(s.$$.fragment,n),t=!0)},o(n){M(s.$$.fragment,n),t=!1},d(n){E(s,n)}}}const f={draft:!0,comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Dynamic Models in Rails 3",description:"How to create dynamic Models in Rails 3",excerpt:"Rails 3 has a lot of nifty new features.",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2016-09-06T09:45:57.000Z",updated_at:"2016-09-06T09:45:57.000Z"};function q(c,s,t){return c.$$set=o=>{t(0,s=r(r({},s),k(o)))},s=k(s),[s]}class S extends _{constructor(s){super(),w(this,s,q,j,g,{})}}export{S as default,f as metadata};
