...
International) parts as I could find. They were a little more expensive, but
some trusted friends told me MSI was the way to go. I have been overly impressed
with the hardware, especially after an uptime of 500+ days. The...`},{comments:v,view:M,layout:S,lang:x,author:k,title:C,description:D,excerpt:T,cover:_,coverImage:A,coverAlt:L,categories:V,tags:W,created_at:B,updated_at:G,preview:P,previewHtml:N,textContent:$}=e;var u=n(`<p>When I built my desktop/server in 2005, I used as many MSI (Micro-Satr
International) parts as I could find. They were a little more expensive, but
some trusted friends told me MSI was the way to go. I have been overly impressed
with the hardware, especially after an uptime of 500+ days. The systemwas
extremely stable. Now I try to buy MSI products whenever possible.</p> <p>So - Last summer I knew I would have enough money to finally buy a laptop of my
...
faster and much more stable than its 32bit counterpart.</p> <h3 id="problems">Problems</h3> <p>The only problem I encountered is that the software for the special buttons
...
as nVidia's version won't work properly.</p> <h2 id="fedora-10-x86_64">Fedora 10 x86_64</h2> <p>After installing Vista, I moved on to Linux. My first Linux distribution
...
of the laptop's hardware works great in Fedora.</p> <p>After installing Fedora, I went straight to the nVidia web site to get drivers
...
with Vista - just use the standard Linux drivers.)  <a href="http://www.nvidia.com/object/cuda_home.html">CUDA</a> is a technology,
...
for all of nVidia's stable drivers (greater than version 1.80).</p> <p>I was expecting to have a few problems with the wireless card, as Linux support
for wireless cards is a little limited, but it works great with the default
drivers. The integrated bluetooth works, as well.</p> <h3 id="problems-1">Problems</h3> <p>There are a few problems with Linux in general on this Laptop. The on-board
...
integrated webcam.</p> <p>So that's it! This laptop is a great buy for anyone - whether you want to play
games or just want a nice big screen to type up your latest best-selling novel.</p>`,1);function O(t,r){const o=d(r,["children","$$slots","$$events","$$legacy"]);p(t,h(()=>o,()=>e,{children:(a,m)=>{var s=u();i(28),l(a,s)},$$slots:{default:!0}}))}export{O as default,e as metadata};
