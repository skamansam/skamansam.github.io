import{S as Ct,i as Mt,s as Pt,C as Xe,y as xt,z as Dt,A as Lt,H as Ht,a0 as _t,g as Wt,d as Ot,B as Rt,L as It,k as l,q as n,a as u,l as r,m as s,r as o,h as t,c as p,n as C,b as h,G as a,I as Bt}from"./index.8495bde4.js";import{P as Nt}from"./post.46c75fab.js";function $t(L){let d,y,v,S,c,m,w,fe,X,_,ye,A,ve,Se,F,we,_e,ee,b,Ie,H,ge,be,te,E,Ee,j,Te,ke,ae,M,bt='<code class="language-html"><span class="token comment">&lt;!--#echo var="REQUEST_URI"--></span></code>',ne,W,Ce,oe,O,Me,ie,R,Pe,le,P,Et='<code class="language-html"><span class="token comment">&lt;!--#directive parameter=value--></span></code>',re,T,xe,q,De,Le,se,x,He,he,B,We,de,I,N,K,Oe,Re,Be,k,Y,Ne,$e,Z,Ge,Ue,Ae,f,z,Fe,je,Q,qe,Ke,J,Ye,Ze,D,ze,Qe,ce,$,Je;return{c(){d=l("h2"),y=n("Introduction"),v=u(),S=l("p"),c=n(`Back in the day, in 2000, I started creating my own Content Management System ,
