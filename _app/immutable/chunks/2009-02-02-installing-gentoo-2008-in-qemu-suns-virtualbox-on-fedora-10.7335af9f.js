import{S as pe,i as ge,s as ye,C as ee,y as ve,z as _e,A as be,H as Ee,a0 as de,g as we,d as Ne,B as Se,L as ue,k as l,q as u,a as p,l as r,m as d,r as m,h as t,c as g,n as M,b as o,G as s,I as Oe}from"./index.8495bde4.js";import{P as Te}from"./post.98a719d8.js";function ke(N){let a,c,I,f,i,h,y,V,L,S,H,A,v,X,k,q,K,R,O,W,B,T,$,C,_,x,j,z,G,E,he=`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
...
virtual machine because it rebuilds everyting on the fly.`),h=p(),y=l("p"),V=u("I went to the Gentoo site and downloaded the minimal install CD for ia64. No luck here - it won't even boot, just hangs."),L=p(),S=l("p"),H=u(`Then I downloaded the minimal install CD for amd64. I got into the boot loader and booted the system, but it hung on the
kernel module loading step.`),A=p(),v=l("p"),X=u(`I finally decided to try a LiveCD. This worked beautifully. However, I couldn't start an X session, as the appropriate
driver was not included on the CD. No real need, as I was installing it on my disk image. So I ran `),k=l("code"),q=u("/opt/installer/bin/install"),K=u(`
...
virtual machines, as Fedora has qemu and a nice graphical virtd client for managing virtual machines. While deciding
on my mainstay distro (in 2000), I evaluated the gamut of Linux distros, so I decided to install Gentoo linux on my
virtual machine because it rebuilds everyting on the fly.`),te.forEach(t),h=g(e),y=r(e,"P",{});var ae=d(y);V=m(ae,"I went to the Gentoo site and downloaded the minimal install CD for ia64. No luck here - it won't even boot, just hangs."),ae.forEach(t),L=g(e),S=r(e,"P",{});var ne=d(S);H=m(ne,`Then I downloaded the minimal install CD for amd64. I got into the boot loader and booted the system, but it hung on the
kernel module loading step.`),ne.forEach(t),A=g(e),v=r(e,"P",{});var U=d(v);X=m(U,`I finally decided to try a LiveCD. This worked beautifully. However, I couldn't start an X session, as the appropriate
driver was not included on the CD. No real need, as I was installing it on my disk image. So I ran `),k=r(U,"CODE",{});var oe=d(k);q=m(oe,"/opt/installer/bin/install"),oe.forEach(t),K=m(U,`
and now it is installing fine. It is taking quite a while to install, however, and I hope to have it finished by the
...
I am currently taking a class on Operating System design and need to do some kernel hacking for the class. I thought about 
modifying the Fedora kernel, but decided against it, as I still want a stable system to operate in. So I looked into 
virtual machines, as Fedora has...`};function De(N,a,c){return N.$$set=I=>{c(0,a=ee(ee({},a),ue(I)))},a=ue(a),[a]}class Ae extends pe{constructor(a){super(),ge(this,a,De,xe,ye,{})}}export{Ae as default,me as metadata};
