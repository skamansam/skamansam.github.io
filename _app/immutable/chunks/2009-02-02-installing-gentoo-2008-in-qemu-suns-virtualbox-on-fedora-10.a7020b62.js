import{S as pe,i as _e,s as ve,C as Z,y as Ee,z as ye,A as ge,H as we,$ as re,g as Ne,d as be,B as Te,L as de,k as s,q as u,a as p,l as r,m as d,r as m,h as t,c as _,n as ue,b as o,G as l,I as Oe}from"./index.37f37dfa.js";import{P as Se}from"./post.47922bc8.js";function xe(b){let n,h,I,f,i,c,v,F,L,T,V,k,E,X,x,H,q,A,O,K,R,S,W,B,y,D,$,j,G,g,ce=`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
...
driver was not included on the CD. No real need, as I was installing it on my disk image. So I ran `),x=s("code"),H=u("/opt/installer/bin/install"),q=u(`
and now it is installing fine. It is taking quite a while to install, however, and I hope to have it finished by the
end of the day. (I have classes all day, and will resume install this evening.)`),A=p(),O=s("p"),K=u("[more to come later…]"),R=p(),S=s("p"),W=u(`So I scrapped the idea of installing Gentoo on qemu. I t was just too slow and too much of a pain. So I decided to
...
driver was not included on the CD. No real need, as I was installing it on my disk image. So I ran `),x=r(U,"CODE",{});var ne=d(x);H=m(ne,"/opt/installer/bin/install"),ne.forEach(t),q=m(U,`
and now it is installing fine. It is taking quite a while to install, however, and I hope to have it finished by the
end of the day. (I have classes all day, and will resume install this evening.)`),U.forEach(t),A=_(e),O=r(e,"P",{});var oe=d(O);K=m(oe,"[more to come later…]"),oe.forEach(t),R=_(e),S=r(e,"P",{});var ie=d(S);W=m(ie,`So I scrapped the idea of installing Gentoo on qemu. I t was just too slow and too much of a pain. So I decided to
try out Sun's VirtualBox for the first time. I really like it! On my machine, it is faster than qemu and VMWare. The
reason for testing on VBox is that qemu doesn't really support 64 bit OSs. I also wanted something that could take
advantage of my hardware, and VMware does an OK job, but not at the level I want. It seems that VBox is everything I
wanted, and i get speeds of almost the same as my host platform. I am running a benchmark program, nbench, and will
post the results here when I finish.`),ie.forEach(t),B=_(e),y=r(e,"H2",{});var J=d(y);D=r(J,"CODE",{});var le=d(D);$=m(le,"nbench"),le.forEach(t),j=m(J," result for host OS (Fedora 10 x86_64 on Intel Core 2 Duo w/ 4Gb RAM):"),J.forEach(t),G=_(e),g=r(e,"PRE",{class:!0});var Ie=d(g);Ie.forEach(t),C=_(e),w=r(e,"H2",{});var Q=d(w);M=r(Q,"CODE",{});var se=d(M);z=m(se,"nbench"),se.forEach(t),Y=m(Q," result for Gentoo 2008 x86_64 on Sun VirtualBox (w/ 768 Mb RAM):"),Q.forEach(t),P=_(e),N=r(e,"PRE",{class:!0});var fe=d(N);fe.forEach(t),this.h()},h(){ue(g,"class","language-undefined"),ue(N,"class","language-undefined")},m(e,a){o(e,n,a),l(n,h),o(e,I,a),o(e,f,a),l(f,i),o(e,c,a),o(e,v,a),l(v,F),o(e,L,a),o(e,T,a),l(T,V),o(e,k,a),o(e,E,a),l(E,X),l(E,x),l(x,H),l(E,q),o(e,A,a),o(e,O,a),l(O,K),o(e,R,a),o(e,S,a),l(S,W),o(e,B,a),o(e,y,a),l(y,D),l(D,$),l(y,j),o(e,G,a),o(e,g,a),g.innerHTML=ce,o(e,C,a),o(e,w,a),l(w,M),l(M,z),l(w,Y),o(e,P,a),o(e,N,a),N.innerHTML=he},p:Oe,d(e){e&&t(n),e&&t(I),e&&t(f),e&&t(c),e&&t(v),e&&t(L),e&&t(T),e&&t(k),e&&t(E),e&&t(A),e&&t(O),e&&t(R),e&&t(S),e&&t(B),e&&t(y),e&&t(G),e&&t(g),e&&t(C),e&&t(w),e&&t(P),e&&t(N)}}}function De(b){let n,h;const I=[b[0],me];let f={$$slots:{default:[xe]},$$scope:{ctx:b}};for(let i=0;i<I.length;i+=1)f=Z(f,I[i]);return n=new Se({props:f}),{c(){Ee(n.$$.fragment)},l(i){ye(n.$$.fragment,i)},m(i,c){ge(n,i,c),h=!0},p(i,[c]){const v=c&1?we(I,[c&1&&re(i[0]),c&0&&re(me)]):{};c&2&&(v.$$scope={dirty:c,ctx:i}),n.$set(v)},i(i){h||(Ne(n.$$.fragment,i),h=!0)},o(i){be(n.$$.fragment,i),h=!1},d(i){Te(n,i)}}}const me={comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Installing Gentoo 2008 in (qemu) Sun's VirtualBox on Fedora 10",description:"Information on virtual OSs and benchmarks",excerpt:"I am currently taking a class on Operating System design and need to do some kernel hacking for the class.",cover:!1,coverImage:"/images/GSoC-logo-horizontal-800.png",coverAlt:"RBE Logo",categories:["linux"],tags:["Fedora","VirtualBox","Gentoo"],created_at:"2009-02-02 08:31",updated_at:"2009-02-02 08:31"};function Me(b,n,h){return b.$$set=I=>{h(0,n=Z(Z({},n),de(I)))},n=de(n),[n]}class Ae extends pe{constructor(n){super(),_e(this,n,Me,De,ve,{})}}export{Ae as default,me as metadata};
