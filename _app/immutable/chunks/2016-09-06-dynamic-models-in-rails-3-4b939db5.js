import{S as _,i as w,s as g,C as r,w as b,x as v,y as x,H as R,Z as u,f as $,t as M,z as E,K as k,k as d,q as H,a as T,l as m,m as y,r as P,h as l,c as A,n as B,b as i,G as C,B as D}from"./index-6a3f2268.js";import{P as Z}from"./post-3c5a9cb3.js";function j(c){let s,t,o,e,n=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">CreateMyDynamicModel</span> <span class="token operator">&lt;</span> ActiveRecord<span class="token double-colon punctuation">::</span>Migration
...
<span class="token keyword">end</span> <span class="token comment">#/end class</span></code>`;return{c(){s=d("p"),t=H(`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),o=T(),e=d("pre"),this.h()},l(a){s=m(a,"P",{});var p=y(s);t=P(p,`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),p.forEach(l),o=A(a),e=m(a,"PRE",{class:!0});var h=y(e);h.forEach(l),this.h()},h(){B(e,"class","language-ruby")},m(a,p){i(a,s,p),C(s,t),i(a,o,p),i(a,e,p),e.innerHTML=n},p:D,d(a){a&&l(s),a&&l(o),a&&l(e)}}}function q(c){let s,t;const o=[c[0],f];let e={$$slots:{default:[j]},$$scope:{ctx:c}};for(let n=0;n<o.length;n+=1)e=r(e,o[n]);return s=new Z({props:e}),{c(){b(s.$$.fragment)},l(n){v(s.$$.fragment,n)},m(n,a){x(s,n,a),t=!0},p(n,[a]){const p=a&1?R(o,[a&1&&u(n[0]),a&0&&u(f)]):{};a&2&&(p.$$scope={dirty:a,ctx:n}),s.$set(p)},i(n){t||($(s.$$.fragment,n),t=!0)},o(n){M(s.$$.fragment,n),t=!1},d(n){E(s,n)}}}const f={draft:!0,comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Dynamic Models in Rails 3",description:"How to create dynamic Models in Rails 3",excerpt:"Rails 3 has a lot of nifty new features.",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2016-09-06T09:45:57.000Z",updated_at:"2016-09-06T09:45:57.000Z"};function z(c,s,t){return c.$$set=o=>{t(0,s=r(r({},s),k(o)))},s=k(s),[s]}class N extends _{constructor(s){super(),w(this,s,z,q,g,{})}}export{N as default,f as metadata};
