...
virtual machines, as Fedora has...`},{comments:x,view:D,layout:L,lang:M,author:_,title:R,description:B,excerpt:G,cover:U,coverImage:F,coverAlt:C,categories:P,tags:X,created_at:K,updated_at:V,preview:$,previewHtml:H,textContent:W}=r;var E=p(`<h1 id="why-i-need-a-virtual-os">Why I Need A Virtual OS</h1> <p>I am currently taking a class on Operating System design and need to do some kernel hacking for the class. I thought about
modifying the Fedora kernel, but decided against it, as I still want a stable system to operate in. So I looked into
...
virtual machine because it rebuilds everyting on the fly.</p> <p>I went to the Gentoo site and downloaded the minimal install CD for ia64. No luck here - it won't even boot, just hangs.</p> <p>Then I downloaded the minimal install CD for amd64. I got into the boot loader and booted the system, but it hung on the
kernel module loading step.</p> <p>I finally decided to try a LiveCD. This worked beautifully. However, I couldn't start an X session, as the appropriate
driver was not included on the CD. No real need, as I was installing it on my disk image. So I ran <code>/opt/installer/bin/install</code> and now it is installing fine. It is taking quite a while to install, however, and I hope to have it finished by the
end of the day. (I have classes all day, and will resume install this evening.)</p> <p>[more to come later…]</p> <p>So I scrapped the idea of installing Gentoo on qemu. I t was just too slow and too much of a pain. So I decided to
...
post the results here when I finish.</p> <h2 id="nbench-result-for-host-os-fedora-10-x86_64-on-intel-core-2-duo-w-4gb-ram"><code>nbench</code> result for host OS (Fedora 10 x86_64 on Intel Core 2 Duo w/ 4Gb RAM):</h2> <pre class="language-undefined"><!></pre> <h2 id="nbench-result-for-gentoo-2008-x86_64-on-sun-virtualbox-w-768-mb-ram"><code>nbench</code> result for Gentoo 2008 x86_64 on Sun VirtualBox (w/ 768 Mb RAM):</h2> <pre class="language-undefined"><!></pre>`,1);function q(l,d){const c=N(d,["children","$$slots","$$events","$$legacy"]);f(l,y(()=>c,()=>r,{children:(h,T)=>{var t=E(),e=n(I(t),16),m=o(e);s(m,()=>`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
...
* Trademarks are property of their respective holder.</code>`),i(e);var a=n(e,4),u=o(a);s(u,()=>`<code class="language-undefined">BYTEmark* Native Mode Benchmark ver. 2 (10/95)
Index-split by Andrew D. Balsa (11/97)
Linux/Unix* port by Uwe F. Mayer (12/96,11/97)
...
Baseline (LINUX)    : AMD K6/233*, 512 KB L2-cache, gcc 2.7.2.3, libc-5.4.38
* Trademarks are property of their respective holder.</code>`),i(a),g(h,t)},$$slots:{default:!0}}))}export{q as default,r as metadata};
