import{S as lo,i as no,s as io,C as xt,w as ao,x as so,y as ro,H as uo,Z as eo,f as co,t as ho,z as fo,K as to,k as l,q as a,a as h,l as n,m as i,r as s,h as t,c as f,n as Ge,b as u,G as o,B as po}from"./index-6a3f2268.js";import{P as mo}from"./post-3c5a9cb3.js";function go(q){let c,g,y,v,d,m,T,O,Re,re,w,S,Z,Ae,qe,Oe,L,Q,Se,Le,Ne,N,U,$e,Me,ue,$,Pe,ce,M,De,he,b,ze,G,He,Fe,fe,P,We,de,k,Ye,R,je,Ze,pe,_,B,J,Qe,Ue,K,V,Be,Je,X,ee,Ke,me,E,Ve,te,Xe,et,ge,I,tt,oe,ot,lt,ye,C,nt,le,it,at,ve,D,st,we,z,rt,_e,H,ut,be,p,A,ct,ne,ht,ft,dt,F,pt,ie,mt,gt,ae,yt,vt,W,wt,se,_t;return{c(){c=l("p"),g=a(`After evaluating all editors and IDEs I could ahold of for Ruby On Rails
...
Ruby words are pretty simple: they:`),pe=h(),_=l("ol"),B=l("li"),J=l("strong"),Qe=a("can begin with a single $ sign"),Ue=h(),K=l("li"),V=l("strong"),Be=a("can begin with a single or double @ sign, a"),Je=h(),X=l("li"),ee=l("strong"),Ke=a("can contain any letter a-z, case insensitive"),me=h(),E=l("p"),Ve=a(`I like to add a fourth rule, just for constants, because when i select a part of
