import{S as _,i as w,s as g,C as r,y as v,z as b,A as R,H as x,a0 as u,g as M,d as $,B as H,L as d,k,q as T,a as C,l as m,m as y,r as E,h as l,c as A,n as D,b as i,G as P,I as B}from"./index.8495bde4.js";import{P as I}from"./post.46c75fab.js";function L(c){let s,t,o,e,n=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">CreateMyDynamicModel</span> <span class="token operator">&lt;</span> ActiveRecord<span class="token double-colon punctuation">::</span>Migration
...
<span class="token keyword">end</span> <span class="token comment">#/end class</span></code>`;return{c(){s=k("p"),t=T(`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),o=C(),e=k("pre"),this.h()},l(a){s=m(a,"P",{});var p=y(s);t=E(p,`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
any version of Rails.`),p.forEach(l),o=A(a),e=m(a,"PRE",{class:!0});var h=y(e);h.forEach(l),this.h()},h(){D(e,"class","language-ruby")},m(a,p){i(a,s,p),P(s,t),i(a,o,p),i(a,e,p),e.innerHTML=n},p:B,d(a){a&&l(s),a&&l(o),a&&l(e)}}}function j(c){let s,t;const o=[c[0],f];let e={$$slots:{default:[L]},$$scope:{ctx:c}};for(let n=0;n<o.length;n+=1)e=r(e,o[n]);return s=new I({props:e}),{c(){v(s.$$.fragment)},l(n){b(s.$$.fragment,n)},m(n,a){R(s,n,a),t=!0},p(n,[a]){const p=a&1?x(o,[a&1&&u(n[0]),a&0&&u(f)]):{};a&2&&(p.$$scope={dirty:a,ctx:n}),s.$set(p)},i(n){t||(M(s.$$.fragment,n),t=!0)},o(n){$(s.$$.fragment,n),t=!1},d(n){H(s,n)}}}const f={draft:!0,comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Dynamic Models in Rails 3",description:"How to create dynamic Models in Rails 3",excerpt:"Rails 3 has a lot of nifty new features.",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2016-09-06T09:45:57.000Z",updated_at:"2016-09-06T09:45:57.000Z",preview:`Rails 3 has a lot of nifty new features. However, this is not about those
features. This article is a short description on how to create dynamic models in
...
`};function q(c,s,t){return c.$$set=o=>{t(0,s=r(r({},s),d(o)))},s=d(s),[s]}class S extends _{constructor(s){super(),w(this,s,q,j,g,{})}}export{S as default,f as metadata};
