import{S as T,i as D,s as S,D as R,x as z,y as B,z as F,A as V,B as A,r as q,p as G,C as H,V as E,e as f,t as b,k as g,c as _,a as h,h as v,d as o,m as w,b as J,g as c,F as x,n as L}from"../../chunks/index-f095e7d9.js";import{P as N}from"../../chunks/post-34b2f3fb.js";function U(u){let e,p,l,t,a=`<code class="language-ruby"><span class="token keyword">class</span> <span class="token class-name">ApplicationController</span> <span class="token operator">&lt;</span> ActionController<span class="token double-colon punctuation">::</span>Base
...
enabled, they should not be using your app. Plan for the future and leave behind
older browsers. You are not expected to support everyone!`),$.forEach(o),this.h()},h(){J(t,"class","language-ruby")},m(s,i){c(s,e,i),x(e,p),c(s,l,i),c(s,t,i),t.innerHTML=a,c(s,n,i),c(s,r,i),x(r,m),c(s,k,i),c(s,d,i),x(d,y)},p:L,d(s){s&&o(e),s&&o(l),s&&o(t),s&&o(n),s&&o(r),s&&o(k),s&&o(d)}}}function Y(u){let e,p;const l=[u[0],I];let t={$$slots:{default:[U]},$$scope:{ctx:u}};for(let a=0;a<l.length;a+=1)t=R(t,l[a]);return e=new N({props:t}),{c(){z(e.$$.fragment)},l(a){B(e.$$.fragment,a)},m(a,n){F(e,a,n),p=!0},p(a,[n]){const r=n&1?V(l,[n&1&&A(a[0]),n&0&&A(I)]):{};n&2&&(r.$$scope={dirty:n,ctx:a}),e.$set(r)},i(a){p||(q(e.$$.fragment,a),p=!0)},o(a){G(e.$$.fragment,a),p=!1},d(a){H(e,a)}}}const I={comments:!0,view:"post",layout:"post",lang:"en",author:"skamansam",title:"Cookie Detection in Rails 3",description:"How to detect cookies in Rails 3",excerpt:"I believe this may be a bad idea, in general, but here is a cheap way",cover:!1,coverImage:!1,coverAlt:"RBE Logo",categories:["ruby"],tags:["Ruby on Rails"],created_at:"2013-04-23T17:14:12.000Z",updated_at:"2016-08-30T00:00:00.000Z",meta:[{property:"og:image",content:"/images/GSoC-logo-horizontal-800.png"},{name:"twitter:image",content:"/images/GSoC-logo-horizontal-800.png"}]};function Z(u,e,p){return u.$$set=l=>{p(0,e=R(R({},e),E(l)))},e=E(e),[e]}class K extends T{constructor(e){super(),D(this,e,Z,Y,S,{})}}export{K as default,I as metadata};
