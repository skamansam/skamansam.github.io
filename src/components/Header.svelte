...
<header class={`flex ${clazz || ''}`}>
  ...
  <div class="text-lg indent-5">Solutions for a troubled world.</div>
  </div>
  ...
  <label for="toggle-dark" class="flex items-center cursor-pointer relative mb-4">
    ...
    <div class="toggle-bg bg-gray-200 border-2 border-gray-200 h-6 mr-5 w-11 rounded-full self-end"></div>
  </label>
  </div>
</header>
